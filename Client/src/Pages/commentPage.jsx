    ...
    return (
        <>
            <div className="bg-gray-700 text-white p-4">
                <MdHome className="text-5xl text-white cursor-pointer hover:text-blue-600 block" onClick={handleNavigateToHome} title="Back to Home" />
            </div>
            ...
            <div className="bg-gray-800 text-white flex flex-col lg:flex-row justify-center items-center select-none">
                <div className="h-auto p-4 bg-white text-black w-70 sm:w-90 lg:w-100 drop-shadow-md flex flex-col gap-3 my-4 rounded">
                    ...
                    <p className="font-bold">{article.description ? article.description : 'Description is not available right now'}</p>
                ...
                <div className="bg-white my-4 w-70 h-fit sm:w-90 mx-auto lg:mx-5 self-start text-black min-h-80 p-4 rounded flex flex-col flex-wrap">
                    ...
                    <div className="flex p-1 gap-2">
                        <input type="text" onChange={handleCommentChange} className="border-1 border-black w-1/2 p-1" value={comment} />
                        <button onClick={handleAddComment} className="bg-black text-center text-white rounded cursor-pointer hover:bg-gray-800 p-1">Add comment</button>
                    </div>
                    {
                        commentArray.length > 0 && commentArray.map((comment, idx) => (
                            <p key={idx}>
